...
SbjList = {{'lx2_s1_b1_mcmst_sk','lx2_s1_b2_mc_sk','lx2_s1_b3_mcmst_sk','lx2_s1_b4_mcmst_sk','lx2_s1_b5_mcmst_sk', 'lx2_s1_b6_mcmst_sk','lx2_s1_b7_mc_sk','lx2_s1_b8_mcmst_sk'},...
           ...
           {'lx2_s5_b1_raw','lx2_s5_b2_raw','lx2_s5_b3_raw','lx2_s5_b4_raw','lx2_s5_b5_raw','lx2_s5_b6_raw','lx2_s5_b7_raw','lx2_s5_b8_raw'},...
...
%
% 2. s01, Block 8, Cnd 1, Rsp 1 has a boundry problem
%    Fix it with: cfg.trl = cfg.trl(2:end,:)
%
...
% The retrieval trialfunction uses the prompt to find the probe word

ConditionList = {[17 27 37 47 57 67 77 87],...
...
%cfg.dataset             = strcat('/home/ddavidson/ddavidson/Lexiko2/Raw/',...
...
cfg.trialdef.respvalue  = ResponseList{Rsp};
...
cfg.trialfun           = 'trialfun_neuromag_lexiko_sme_ret_new';
...
d{Block, Cnd, Rsp} = ft_preprocessing(cfg); 
...
% cfg.resamplefs = 250;
% cfg.detrend    = 'no';
% d{Block, Cnd, Rsp} = ft_resampledata(cfg, d{Block, Cnd, Rsp});
...
%              int2str(Sbj),...
%              '_ret_art-rejection-series-2.mat');

fdat = strcat('/home/ddavidson/ddavidson/Lexiko2/Data/lx02_s',...
              int2str(Sbj),...
              '_pwr_ret_art-rejection-series-2.mat');
...
% Testing version -- not used
SbjList = {{'lx02_s01_b1_mc_lowcor','lx02_s01_b2_mc_lowcor','lx02_s01_b3_mc_lowcor','lx02_s01_b4_mc_lowcor','lx02_s01_b5_mc_lowcor','lx02_s01_b6_mc_lowcor','lx02_s01_b7_mc_lowcor','lx02_s01_b8_mc_lowcor'},...
           {'lx2_s2_b1_mc_lowcor','lx2_s2_b2_mcmst','lx2_s2_b3_mc_lowcor','lx2_s2_b4_mcmst','lx2_s2_b5_mcmst','lx2_s2_b6_mc_lowcor','lx2_s2_b7_mcmst','lx2_s2_b8_mcmst'},...
           {'lx2_s3_b1_mcmst','lx2_s3_b2_mc_lowcor','lx2_s3_b3_mcmst','lx2_s3_b4_mcmst','lx2_s3_b5_mcmst','lx2_s3_b6_mcmst','lx2_s3_b7_mc_lowcor','lx2_s3_b8_mcmst'},...
           {'lx2_s4_b1_mc_lowcor','lx2_s4_b2_mc_lowcor','lx2_s4_b3_mcmst','lx2_s4_b4_mcmst','lx2_s4_b5_mcmst', 'lx2_s4_b6_mc_lowcor','lx2_s4_b7_mcmst','lx2_s4_b8_mcmst'},...
